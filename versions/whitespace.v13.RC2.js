...
//	'GETN'
//];
b.innerHTML = 'in<textarea>js1k</textarea><p>go</p>out<textarea></textarea><textarea></textarea>'
...
//				m=Math.min(i[h++]+1,o.length);
			...
			function(s){b.children[2].value+=String.fromCharCode(o.pop()|0)}, // putc
			function(s){b.children[2].value+=o.pop()|0}, // putn
